...
#define MATCH_FMV_F_H 0xec000053
#define MASK_FMV_F_H  0xfff0707f
...
#define MATCH_FMV_H_F 0xfc000053
#define MASK_FMV_H_F  0xfff0707f
...
#define MATCH_PAL_H 0x400102b
#define MASK_PAL_H  0x600707f
#define MATCH_PAH_H 0x400202b
#define MASK_PAH_H  0x600707f
#define MATCH_LSA0_H 0x400000b
#define MASK_LSA0_H  0xfe00007f
#define MATCH_LSA1_H 0xc00000b
#define MASK_LSA1_H  0xfe00007f
#define MATCH_LSA2_H 0x1400000b
#define MASK_LSA2_H  0xfe00007f
#define MATCH_LSA3_H 0x1c00000b
#define MASK_LSA3_H  0xfe00007f
#define MATCH_PMAX_H 0xfc001053
#define MASK_PMAX_H  0xfff0707f
#define MATCH_PMIN_H 0xfc002053
#define MASK_PMIN_H  0xfff0707f
#define MATCH_PSUM_H 0xfc003053
#define MASK_PSUM_H  0xfff0707f
#define MATCH_PAVE_H 0xfc004053
#define MASK_PAVE_H  0xfff0707f
#define MATCH_RELU_H 0xfc005053
#define MASK_RELU_H  0xfff0707f
#define MATCH_RS1_H 0xec001053
#define MASK_RS1_H  0xfff0707f
#define MATCH_RS2_H 0xec002053
#define MASK_RS2_H  0xfff0707f
#define MATCH_RS3_H 0xec003053
#define MASK_RS3_H  0xfff0707f
#define MATCH_FI0_H 0xec004053
#define MASK_FI0_H  0xfff0707f
#define MATCH_CR_H 0xec005053
#define MASK_CR_H  0xfff0707f
#define MATCH_TR_H 0xec006053
#define MASK_TR_H  0xfff0707f
...
DECLARE_INSN(fmv_f_h, MATCH_FMV_F_H, MASK_FMV_F_H)
...
DECLARE_INSN(fmv_h_f, MATCH_FMV_H_F, MASK_FMV_H_F)
...
DECLARE_INSN(pal_h, MATCH_PAL_H, MASK_PAL_H)
DECLARE_INSN(pah_h, MATCH_PAH_H, MASK_PAH_H)
DECLARE_INSN(lsa0_h, MATCH_LSA0_H, MASK_LSA0_H)
DECLARE_INSN(lsa1_h, MATCH_LSA1_H, MASK_LSA1_H)
DECLARE_INSN(lsa2_h, MATCH_LSA2_H, MASK_LSA2_H)
DECLARE_INSN(lsa3_h, MATCH_LSA3_H, MASK_LSA3_H)
DECLARE_INSN(pmax_h, MATCH_PMAX_H, MASK_PMAX_H)
DECLARE_INSN(pmin_h, MATCH_PMIN_H, MASK_PMIN_H)
DECLARE_INSN(psum_h, MATCH_PSUM_H, MASK_PSUM_H)
DECLARE_INSN(pave_h, MATCH_PAVE_H, MASK_PAVE_H)
DECLARE_INSN(relu_h, MATCH_RELU_H, MASK_RELU_H)
DECLARE_INSN(rs1_h, MATCH_RS1_H, MASK_RS1_H)
DECLARE_INSN(rs2_h, MATCH_RS2_H, MASK_RS2_H)
DECLARE_INSN(rs3_h, MATCH_RS3_H, MASK_RS3_H)
DECLARE_INSN(fi0_h, MATCH_FI0_H, MASK_FI0_H)
DECLARE_INSN(cr_h, MATCH_CR_H, MASK_CR_H)
DECLARE_INSN(tr_h, MATCH_TR_H, MASK_TR_H)
